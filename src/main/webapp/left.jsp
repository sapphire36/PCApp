...
<!-- 	<div class="lefttop"><span></span>通讯录</div> -->    
    ...
    <span><img src="images/leftico01.png" /></span>管理信息
    	...
    	<ul class="menuson">
        <li class="active"><cite></cite><a href="right.jsp" target="rightFrame">用户信息</a><i></i></li>
        <li><cite></cite><a href="imgtable.jsp" target="rightFrame">设备信息</a><i></i></li>
    ...
    <ul class="menuson">
        <li><cite></cite><a href="#">信息发布</a><i></i></li>
    ...
    <ul class="menuson">
        <li><cite></cite><a href="#">费率管理</a><i></i></li>
        <li><cite></cite><a href="#">报表管理</a><i></i></li>
        <li><cite></cite><a href="#">数据统计</a><i></i></li>
        <li><cite></cite><a href="#">查看日志</a><i></i></li>
    </ul>
